...
import com.ionoscloud.dbaasmariadb.model.BackupListAllOf;
import com.ionoscloud.dbaasmariadb.model.BackupResponse;
import com.ionoscloud.dbaasmariadb.model.Pagination;
import com.ionoscloud.dbaasmariadb.model.PaginationLinks;
...
public class BackupList {
  ...
  public BackupList id(String id) {
  ...
  **/
  ...
  public BackupList items(List<BackupResponse> items) {
    
    this.items = items;
    return this;
  }

  public BackupList addItemsItem(BackupResponse itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public BackupList offset(Integer offset) {
  ...
  **/
  ...
  public BackupList limit(Integer limit) {
  ...
  **/
  ...
  public BackupList total(Integer total) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "200", value = "The total number of elements matching the request (without pagination). ")
  ...
  public BackupList links(PaginationLinks links) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, backupList.id) && Objects.equals(this.items, backupList.items) && Objects.equals(this.offset, backupList.offset) && Objects.equals(this.limit, backupList.limit) && Objects.equals(this.total, backupList.total) && Objects.equals(this.links, backupList.links);
  }
