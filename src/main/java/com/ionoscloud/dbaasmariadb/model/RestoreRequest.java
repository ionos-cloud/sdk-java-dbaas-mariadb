...
public class RestoreRequest {
  ...
  public RestoreRequest backupId(String backupId) {
  ...
  **/
  ...
  public RestoreRequest recoveryTargetTime(OffsetDateTime recoveryTargetTime) {
  ...
  **/
  ...
  @ApiModelProperty(example = "2020-12-10T13:37:50+01:00", value = "The timestamp to which the cluster should be restored. If empty, the backup will be applied to the latest timestamp.  This value must be supplied as ISO 8601 timestamp, the backup will be replayed up until the given timestamp. If empty, the backup will be applied completely.  Must be within the earliestRecoveryTargetTime and now.  The earliestRecoveryTargetTime can be looked up in the backup object. ")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.backupId, restoreRequest.backupId) && Objects.equals(this.recoveryTargetTime, restoreRequest.recoveryTargetTime);
  }
